...
- Experimentalists can now measure tens of thousands of traits with RNA sequencing and mass spectrometry
...
- New analysis tools, such as our test of pleiotropy for multiparental populations, are needed 
...
# `r Citet(myBib, "jiang1995multiple")` pleiotropy test
...
- Fit the model: $$vec(Y) = Xvec(B) + vec(G) + vec(E)$$ for each ordered pair of markers
...
- `r Citet(myBib, c("logan2013high", "recla2014precise"), .opts = list(max.names = 1))` genotyped and phenotyped 261 Diversity Outbred mice    
    ...
    - Motivated us to ask if the QTL containing *Hydin* also affects "percent time in light" 
